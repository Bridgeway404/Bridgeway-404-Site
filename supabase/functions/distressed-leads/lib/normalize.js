...
export function looksLikeEntity(name) {
  ...
  if (/\d/.test(s) && /\b(ST|AVE|RD|DR|LN|BLVD|PKWY|HWY)\b/i.test(s)) return true; // "123 MAIN ST LLC"-style
